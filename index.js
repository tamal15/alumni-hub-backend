    ...
    app.delete('/deleteadmin/:id',async(req,res)=>{
        ...
        app.post('/init', async(req, res) => {
            ...
            const data = {
                ...
                tran_id: uuidv4(),
                success_url: 'https://burger-backend-production.up.railway.app/success',
                fail_url: 'https://burger-backend-production.up.railway.app/fail',
                cancel_url: 'https://burger-backend-production.up.railway.app/cancel',
